...
CREATE TABLE `orders` (
  ...
  `order_code` varchar(18) NOT NULL,
  `user_id` int(11) NOT NULL,
...
INSERT INTO `orders` (`id`, `order_code`, `user_id`, `product_id`, `address_id`, `order_status_id`, `gross_amount`, `create_date`, `update_date`) VALUES
(1, 'OR20230317Y3OJG2XI', 2, 131, 1, 3, 5000000, '2023-03-17 02:24:38', '2023-03-17 02:25:30'),
(2, 'OR20230317O08FXRVI', 3, 127, 2, 1, 17000000, '2023-03-17 03:53:15', '2023-03-17 03:53:15'),
(3, 'OR20230317USYXP4JL', 4, 129, 3, 1, 7500000, '2023-03-17 04:01:55', '2023-03-17 04:01:55'),
(4, 'OR20230317EYNDCKHF', 3, 129, 2, 1, 7500000, '2023-03-17 04:15:54', '2023-03-17 04:15:54'),
(5, 'OR20230317NNMXMRNA', 3, 129, 2, 1, 7500000, '2023-03-17 04:48:02', '2023-03-17 04:48:02'),
(6, 'OR20230319MPHTOJAU', 2, 129, 1, 1, 7500000, '2023-03-18 19:09:03', '2023-03-18 19:09:03'),
(7, 'OR20230319X62UAG83', 2, 129, 1, 3, 7500000, '2023-03-19 11:29:30', '2023-03-19 11:55:45');
...
INSERT INTO `order_status` (`id`, `name`, `description`, `active`, `create_date`, `update_date`) VALUES
(1, 'pending', 'description text for status', '1', '2023-03-17 01:59:07', '2023-03-17 01:59:07'),
(2, 'canceled', 'description text for status', '1', '2023-03-17 01:59:07', '2023-03-17 01:59:07'),
(3, 'success', 'description text for status', '1', '2023-03-17 01:59:07', '2023-03-17 01:59:07');
...
INSERT INTO `payments` (`id`, `order_id`, `gross_amount`, `payment_type`, `interest_rate`, `tenor`, `status_id`, `create_date`, `update_date`) VALUES
(1, 1, 5000000, '1', 0, 0, 3, '2023-03-17 02:24:38', '2023-03-17 02:25:30'),
(2, 2, 17000000, '1', 0, 0, 1, '2023-03-17 03:53:15', '2023-03-17 03:53:15'),
(3, 3, 7500000, '1', 0, 0, 1, '2023-03-17 04:01:55', '2023-03-17 04:01:55'),
(4, 4, 7500000, '1', 0, 0, 1, '2023-03-17 04:15:54', '2023-03-17 04:15:54'),
(5, 5, 7500000, '1', 0, 0, 1, '2023-03-17 04:48:02', '2023-03-17 04:48:02'),
(6, 6, 7500000, '1', 0, 0, 1, '2023-03-18 19:09:03', '2023-03-18 19:09:03'),
(7, 7, 7500000, '2', 0, 12, 1, '2023-03-19 11:29:30', '2023-03-19 11:29:30');
...
CREATE TABLE `payment_detail` (
  ...
  `payment_type` enum('1','2','3') NOT NULL DEFAULT '1',
  `due_date` datetime NOT NULL,
  `payment_gateway_token` varchar(36) DEFAULT NULL,
  `payment_gateway_transaction_id` varchar(36) DEFAULT NULL,
  `payment_gateway_transaction_status` varchar(20) DEFAULT NULL,
...
INSERT INTO `payment_detail` (`id`, `transaction_id`, `payment_id`, `amount`, `payment_type`, `due_date`, `payment_gateway_token`, `payment_gateway_transaction_id`, `payment_gateway_transaction_status`, `expiry_time`, `create_date`, `update_date`) VALUES
(1, 'c475d21b5fa8c78542afedc5f433b22e', 1, 5000000, '1', '0000-00-00 00:00:00', NULL, '0e856839-403c-4d2b-a0d8-5c35511f0b03', 'success', '2023-03-18 09:24:46', '2023-03-17 02:24:38', '2023-03-17 02:25:30'),
(2, 'c210c9679941fca4245cead0372bfa43', 2, 17000000, '1', '0000-00-00 00:00:00', NULL, '3f61dc79-0da3-4b16-8e57-9f3d85cf11d1', 'pending', '2023-03-18 10:53:29', '2023-03-17 03:53:15', '2023-03-17 03:53:51'),
(3, '1ddf42a991b97cf44266937babaddda8', 3, 7500000, '1', '0000-00-00 00:00:00', NULL, 'c3447d99-d229-4171-b304-044fcc4febeb', 'pending', '2023-03-18 11:02:24', '2023-03-17 04:01:55', '2023-03-17 04:02:49'),
(4, '919aecc47dba745d9e7ac284a4cf33dc', 4, 7500000, '1', '0000-00-00 00:00:00', NULL, NULL, NULL, '0000-00-00 00:00:00', '2023-03-17 04:15:54', '2023-03-17 04:15:54'),
(5, '7cb2d2cebfa01c223d0051c3081738b5', 5, 7500000, '1', '0000-00-00 00:00:00', NULL, 'e1b12d60-f323-49d8-bc6c-5c1980cae15c', 'pending', '2023-03-18 11:48:08', '2023-03-17 04:48:02', '2023-03-17 04:48:15'),
(6, 'd5a748828746c52f249d1e2541c1a785', 6, 7500000, '1', '0000-00-00 00:00:00', 'a919cc7e-fa4a-40a8-875d-5cba152644b4', '43278163-b3ca-4b1b-85ff-3889165e246b', 'pending', '2023-03-20 02:10:00', '2023-03-18 19:09:03', '2023-03-18 19:10:01'),
(7, '216bfa6a45a645724a84361a097d40a9', 7, 2000000, '2', '2023-03-20 00:00:00', '7334b98d-9643-4488-8196-a5c20ebfc684', 'd885b631-ed03-47f9-b617-17082ccedc3c', 'success', '2023-03-20 18:29:37', '2023-03-19 11:29:30', '2023-03-19 11:55:45'),
(8, '08fef8f7bf4455b4d5c4c0ab29a1fb9d', 7, 458333, '3', '2023-04-20 00:00:00', '92d89bdb-47b4-424f-ba66-ca0b24897fe6', 'e77b1f48-db67-4845-8374-f58f2047b39e', 'success', '2023-03-21 07:15:57', '2023-03-19 11:55:45', '2023-03-20 00:16:16'),
(9, '163d3368e543f469f138ec2bf9962f10', 7, 458333, '3', '2023-05-20 00:00:00', NULL, NULL, NULL, '0000-00-00 00:00:00', '2023-03-20 00:16:16', '2023-03-20 00:16:16');
...
INSERT INTO `payment_status` (`id`, `name`, `description`, `active`, `create_date`, `update_date`) VALUES
(1, 'pending', 'description text for status', '1', '2023-03-17 01:59:07', '2023-03-17 01:59:07'),
(2, 'in_installment', 'description text for status', '1', '2023-03-17 01:59:07', '2023-03-17 01:59:07'),
(3, 'settlement', 'description text for status', '1', '2023-03-17 01:59:07', '2023-03-17 01:59:07'),
(4, 'canceled', 'description text for status', '1', '2023-03-17 01:59:07', '2023-03-17 01:59:07');
...
(20, 12, 'Tanah', 'tanah', 'Miliki lahan yang berpotensi menguntungkan untuk anda', 0, 1),
(21, 20, 'Rumah', 'rumah', 'RUmah hunian yang penuh dengan nilai tambah, membuat anda dan keluarga nyaman dan sejahtera', 0, 1),
(22, 21, 'RUMAH IMPIAN', 'untitled', NULL, 3, 1),
(23, 21, 'RUMAH lt. 2', 'untitled', NULL, 0, 1);
...
CREATE TABLE `testimonials` (
  ...
  `image` text DEFAULT NULL,
  `slug_testimonial` text DEFAULT NULL,
...
(2, 'Pikachu', 'Pokemon Tamer', 'Pokemon Foundation', 'It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using \'Content here, content here\', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for \'lorem ipsum\' will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).\r\n', 'imgtestimonial_Pikachu_1678930521.jpg', '2-pikachu', '2020-11-25', '2023-03-16', 'publish'),
(3, 'vicky ', '', 'mitra jaya', '-----------------------------------', 'imgtestimonial_vicky__1678930854.jpg', 'vicky', '2023-03-16', NULL, 'publish');
...
(2, '103.167.34.82', NULL, '$2y$10$Ro94APMGt6cb/hPQpwaj8uZh45w2lrutinWdoVVGkyQHOi7an1NYG', 'a@a.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1679019021, 1679459099, 1, 'test', NULL, NULL, NULL),
(3, '36.72.215.38', NULL, '$2y$10$XU9nOCugtlIDVSHJfaCR.uzRyqH568iEgMzQjrcN0I4mj2rx882Xm', 'faizah@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1679024807, 1679026513, 1, 'Faizah', NULL, NULL, NULL),
(4, '182.1.113.112', NULL, '$2y$10$eUccNGjAO6GUK.NE5uTKRetVsJcDDFXY5Iql0w7FrnmudAHQ83uW.', 'ee@gg.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1679025479, 1679025513, 1, 'eee', NULL, NULL, NULL),
(5, '36.72.215.38', NULL, '$2y$10$7Bo4h5PVx4Ud050Vr/vfMuEz6fiwycxtaWvjdbMIXqBvWEw14hhLS', 'ipunkrochman@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1679027847, 1679034473, 1, 'ACHMAD SYAIFUR ROCHMAN', NULL, NULL, NULL);
...
INSERT INTO `user_address` (`id`, `user_id`, `full_name`, `phone`, `address`, `is_main`, `active`) VALUES
(1, 2, 'Test Alamat', '8080808080', 'Jl. Tentara Pelajar No.39, Panggel, Panjer, Kec. Kebumen, Kabupaten Kebumen, Jawa Tengah 54311', '1', '1'),
(2, 3, 'Faizah', '811', 'Tanuraksan Kebumen jawa Tengah', '1', '1'),
(3, 4, 'eeee', '55667777', 'dsddsd', '1', '1');
...
--
ALTER TABLE `testimonials`
  MODIFY `testimonial_id` int(5) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
