...
class Products extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model(array('Admin/Products_model', 'Admin/ShopCategories_model'));
    ...
    public function index($page = 0)
    {
        ...
        $data['product_categories'] = $this->ShopCategories_model->getShopCategories(null, null, 2);
        ...
        $data['title'] = 'Admin - Daftar Produk';
        $data['site'] = $site;
        $data['isi'] = 'admin/ecommerce/products';
