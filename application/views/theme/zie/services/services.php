...
<div class="row " style="box-shadow: 0 25px 50px 0 rgb(0 0 0 / 20%);}">
  <div class="col-md-3 text-center">
    <a class="decoration-n" href="<?=base_url()?>services/2d-3d-animation">
      <div class="py-3 m-2 services-category-tab <?=($category=='2d-3d-animation')?'active':'';?>">
  ...
  <div class="col-md-3 text-center">
    <a class="decoration-n" href="<?=base_url()?>services/audio-visual">
      <div class="py-3 m-2 services-category-tab <?=($category=='audio-visual')?'active':'';?>">
  ...
  <div class="col-md-3 text-center">
    <a class="decoration-n" href="<?=base_url()?>services/design-graphic">
      <div class="py-3 m-2 services-category-tab <?=($category=='design-graphic')?'active':'';?>">
  ...
  <div class="col-md-3 text-center">
    <a class="decoration-n" href="<?=base_url()?>services/course-education">
      <div class="py-3 m-2 services-category-tab <?=($category=='course-education')?'active':'';?>">
