...
<div class="col-md-6">
    <div class="form-group">
        ...
        <div class="imagePreview"><img src="<?php echo base_url('img/gallery/'.$gallery['image']) ?>" width="458px" height="355px"></div>
    </div>
</div>
<div class="col-md-6">
    	<div class="form-group input-group-lg">
            ...
            <select name="type" class="form-control">
                ...
                <option value="youtube" <?=$gallery['type']=="youtube" ? 'selected':''?>>Youtube Embed</option>               
                <option value="video" <?=$gallery['type']=="video" ? 'selected':''?>>Video</option>                                         
            </select>
        </div>
        <div class="form-group input-group-lg">
            <label>Video Url</label>
            <input type="text" name="video_url" class="form-control" value="<?=$gallery['video_url']?>" placeholder="url">
        </div>   
        <div class="form-group">
            ...
            <select name="position" class="form-control">
              ...
              <?php if($gallery['position']=="project") { echo "selected"; } ?>
              >project / work</option>}                                              

              <option value="gallery" 
              <?php if($gallery['position']=="gallery") { echo "selected"; } ?>
              >gallery</option>}  
