...
<div class="panel panel-primary text-center no-boder bg-color-gray">
    ...
    <a href="<?php echo base_url()?>admin/products">Management Products</a>
    </div></div></div> 
...
<div class="panel panel-primary text-center no-boder bg-color-gray">
    ...
    <div class="panel-footer back-footer-white putih">
    <a href="<?php echo base_url()?>admin/clients">Management Clients</a>
    </div></div></div>  
...
<div class="panel panel-primary text-center no-boder bg-color-gray">
    ...
    <div class="panel-footer back-footer-white putih">
    <a href="<?php echo base_url()?>admin/downloads">Management Downloads</a>
    </div></div></div>      -->
