...
<form action="<?php echo base_url('admin/dashboard/locations') ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <textarea rows="10" name="google_maps" placeholder="Google Maps Frame" class="form-control" value="about" id="about"><?php echo $site['google_maps']; ?></textarea>
        </div>
    </div>
    
    <div class="col-md-6" style="padding-bottom: 20px;">
    	<label>Example:</label><br>
        <img src="<?php echo base_url('assets/upload/image/frame_maps.png/') ?>" style="max-width:500px; height:auto;">
    </div>
    <div class="col-md-12">
